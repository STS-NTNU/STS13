...
dkpro_feats = ['WordNGramJaccardMeasure_4_stopword-filtered',
               'WordNGramJaccardMeasure_4', 'LongestCommonSubsequenceComparator',
               'CharacterNGramMeasure_4', 'SemanticWordOrderLeacockAndChodorow',
               'CharacterNGramMeasure_2', 'CharacterNGramMeasure_3',
               'LongestCommonSubsequenceNormComparator', 'WordNGramJaccardMeasure_1',
               'WordNGramJaccardMeasure_2_stopword-filtered', 'WordNGramJaccardMeasure_3',
               'WordNGramContainmentMeasure_1_stopword-filtered',
               'LongestCommonSubstringComparator', 'GreedyStringTiling_3',
