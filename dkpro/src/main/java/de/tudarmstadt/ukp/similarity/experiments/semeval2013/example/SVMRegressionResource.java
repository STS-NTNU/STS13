...
import de.tudarmstadt.ukp.similarity.experiments.semeval2013.example.SVMRegressionSimilarityMeasure;
...
public class SVMRegressionResource
        extends JCasTextSimilarityResourceBase
{
            ...
            throws ResourceInitializationException
    {
        ...
        try {
            ...
            measure = new SVMRegressionSimilarityMeasure(trainArff, testArff);
        }
        catch (Exception e) {
