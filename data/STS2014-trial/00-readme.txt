...
The trial dataset contains the following:
  ...
  STS.output.image.txt            tab separated sample input file with 
                                  sentence pairs
  STS.output.OnWN.txt             "
  STS.output.tweet-news.txt       "
  STS.output.deft-news.txt        "
  STS.output.deft-forum.txt       "
...
The trial dataset comprises the 2012 and 2013 datasets, which can be used to
...
- STS.output.deft-news.txt: A subset of news article data in the DEFT
  project.

- STS.output.deft-forum.txt: A subset of discussion forum data in the
  DEFT project.
